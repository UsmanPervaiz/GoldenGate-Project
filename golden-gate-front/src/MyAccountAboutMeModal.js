					...
					<div id="about-me-modal-content" ref="about-me-modal-content" className="about-me-modal-content">
						...
						<form onSubmit={(event) => this.props.aboutMeModalUpdateButtonClicked(event, this.aboutMeEditCloseClicked.bind(this))} >
							<div id="edit-first-name">
								...
								<input autoComplete="off" className="all-new-user-data" id="new-first-name" type="text" defaultValue={this.props.memberInfo.firstName} onChange={(event) => this.props.aboutMeFirstNameChanged(event)}/>
					    	</div>
					    	<div id="edit-last-name">
					    		<label className="all-edit-account-labels" htmlFor="new-last-name">Last Name</label>
								<input autoComplete="off" className="all-new-user-data" id="new-last-name" type="text" defaultValue={this.props.memberInfo.lastName} onChange={(event) => this.props.aboutMeLastNameChanged(event)} />					
							</div>
							<div id="edit-email">
								<label className="all-edit-account-labels" htmlFor="new-user-email">Email</label>
								<input autoComplete="off" className="all-new-user-data" id="new-user-email" type="email" defaultValue={this.props.memberInfo.email} onChange={(event) => this.props.aboutMeEmailChanged(event)}/>
							</div>
							<div id="new-gender">
								<h3>Gender</h3>
							...
							<div id="new-dob">
								...
								<div id="dob-day" className="dob-data">
									...
									<input autoComplete="off" className="all-new-user-data2" id="new-dob-month" type="text"  defaultValue={this.props.memberInfo.dob.slice(5,7)} onChange={(event) => this.props.aboutMeDateOfBirthMonthOrDayChanged(event, "newDobMonth")} />
								</div>
								<div id="dob-month" className="dob-data">
									<label className="all-edit-dob-labels" for="new-dob-day">Day</label>
									<input autoComplete="off" className="all-new-user-data2" id="new-dob-day" type="text"  defaultValue={this.props.memberInfo.dob.slice(-2)} onChange={(event) => this.props.aboutMeDateOfBirthMonthOrDayChanged(event, "newDobDay")} />
								</div>
								<div id="dob-year" className="dob-data">
									<label className="all-edit-dob-labels" for="new-dob-year">Year</label>
									<input autoComplete="off" className="all-new-user-data2" id="new-dob-year" type="text"  defaultValue={this.props.memberInfo.dob.slice(0,4)} onChange={(event) => this.props.aboutMeDateOfBirthYearChanged(event)} />
								</div>
							</div>
